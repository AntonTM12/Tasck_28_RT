...
class OtherPage(BasePage):
    def __init__(self, driver, timeout=10):
        ...
        url = os.getenv('MAIN_URL') or 'https://b2c.passport.rt.ru'
        driver.get(url)
        self.vk = driver.find_element(*OtherLocators.vk_buton)
        self.googl = driver.find_element(*OtherLocators.Google_btn)
        self.mail = driver.find_element(*OtherLocators.Mail_btn)
        self.ok = driver.find_element(*OtherLocators.OK_btn)
        self.ya = driver.find_element(*OtherLocators.Yandex_btn)
        self.vostonovit_pass = driver.find_element(*OtherLocators.vost_porol)
